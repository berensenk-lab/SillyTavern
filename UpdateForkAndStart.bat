@echo off
REM ========================================
REM OPTIONAL: Non-Docker Fork Update + Start Script
REM ========================================
REM
REM This script updates a SillyTavern fork from git and runs it natively (NOT in Docker).
REM It handles branch switching and upstream syncing for fork maintenance.
REM
...
REM   - Project must be cloned via git as a fork
REM
REM ========================================
